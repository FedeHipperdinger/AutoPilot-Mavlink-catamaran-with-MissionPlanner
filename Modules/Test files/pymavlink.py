...
# in Python 3.5 and later, the typing module lives in the stdlib, and installing this package has NO EFFECT,
#import typing
...
#from typing import List, Mapping, Optional, Sequence, Tuple, Type, Union, cast
...
MAVLINK_IGNORE_CRC = 1 #os.getenv("MAV_IGNORE_CRC") #environ attribute is not implemented
...
class MAVLink(object):
    ...
    def __init__(self, file: Any, srcSystem: int = 0, srcComponent: int = 0, use_native: bool = False) -> None:
        ...
        self.mav20_unpacker = struct.Struct("<1sBBBBBBHB") #micropython struct no soporta el tipo c (carácter), pero si se puede usar s para una cadena de longitud fija. Para un solo carácter, usaremos una cadena de un solo byte (1s).
        self.mav10_unpacker = struct.Struct("<1sBBBBB")
